...
namespace ScriptLinkStandard.Objects
{
    ...
    public class OptionObject : IEquatable<OptionObject>, IOptionObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public OptionObject Clone() => (OptionObject)ScriptLinkHelpers.Clone(this);
        ...
        /// <summary>
        /// Returns a <see cref="string"/> with all of the contents of the <see cref="OptionObject"/> formatted as JSON.
        /// </summary>
        /// <returns><see cref="string"/> of all of the contents of the <see cref="OptionObject"/> formatted as JSON.</returns>
        ...
        /// </summary>
        /// <returns></returns>
        public OptionObject ToReturnOptionObject() => (OptionObject)ScriptLinkHelpers.GetReturnOptionObject(this);
        ...
        /// <returns></returns>
        public OptionObject ToReturnOptionObject(int errorCode, string errorMessage) => (OptionObject)ScriptLinkHelpers.GetReturnOptionObject(this, errorCode, errorMessage);
