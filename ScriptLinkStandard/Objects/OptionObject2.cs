...
namespace ScriptLinkStandard.Objects
{
    ...
    public class OptionObject2 : IEquatable<OptionObject2>, IOptionObject2
    {
        ...
        /// </summary>
        /// <returns></returns>
        public OptionObject2 Clone() => (OptionObject2)ScriptLinkHelpers.Clone(this);
        ...
        /// </summary>
        /// <returns></returns>
        public OptionObject2015 ToOptionObject2015() => (OptionObject2015)ScriptLinkHelpers.TransformToOptionObject2015(this);

        /// <summary>
        /// Creates an <see cref="OptionObject2"/> with the minimal information required to return.
        /// </summary>
        /// <returns></returns>
        public OptionObject2 ToReturnOptionObject() => (OptionObject2)ScriptLinkHelpers.GetReturnOptionObject(this);
        ...
        /// <returns></returns>
        public OptionObject2 ToReturnOptionObject(int errorCode, string errorMessage) => (OptionObject2)ScriptLinkHelpers.GetReturnOptionObject(this, errorCode, errorMessage);

        /// <summary>
        /// Returns a <see cref="string"/> with all of the contents of the <see cref="OptionObject2"/> formatted as XML.
        /// </summary>
        /// <returns><see cref="string"/> of all of the contents of the <see cref="OptionObject2"/> formatted as XML.</returns>
